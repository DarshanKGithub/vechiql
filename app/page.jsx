      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
            Advanced AI Car Search and test drive thousands of vechiles.
          </p>
        </div>
        {/* Search */}
        <HomeSearch/> 
   ...
   return <CarCard key={car.id} car={car}/>
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-col-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
       ...
       return <Link key={make.name} href={`/car?make=${make.name}`}
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <p className="text-gray-600">
          Thousands of verified vehicles from trusted dealearship and 
          private sellers.
        </p>
        </div>
        <div className="text-center">
        ...
        <p className="text-gray-600">
         Verified listing and secure bookig secure for peace of mind
        </p>
        </div>
      </div>
    </div>
   ...
   <section className="py-12 bg-gray-50">
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-col-2 md:grid-cols-4  gap-4">
       ...
       return <Link key={type.name} href={`/cars?bodyTyp=${type.name}`}
 ...
 return (       
  ...
  <section className="py-16 dotted-background text-white">
    <div className="container mx-auto px-4 text-center ">
      ...
      <p className="text-xl text-blue-100 mb-8 max-w-2xlmx-auto">Join thousands of satisfied customers who found their perfect 
        vechile through our platoform
        </p>
